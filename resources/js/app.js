...
const AppleModal = Swal.mixin({
    customClass: {
        ...
        confirmButton: 'bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-6 py-2 font-medium',
        cancelButton: 'bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-xl px-6 py-2 font-medium',
